  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        <div className="inset-0 absolute -z-30 opacity-5" style={{backgroundImage: `url(${grainImage.src})`}}></div>
        ...
        <HeroOrbit size={520} rotation={-41} shouldOrbit orbitDuration="34s">
          <div className="bg-green-300/20 size-2 rounded-full"></div>
        </HeroOrbit>
        ...
        <HeroOrbit size={710} rotation={144} shouldOrbit orbitDuration="44s">
          <SparkleIcon className="size-14 text-emerald-300/20" shouldSpin spinDuration="3s"/>
        </HeroOrbit>

        <HeroOrbit size={720} rotation={85} shouldOrbit orbitDuration="46s">
          <div className="bg-green-300/20 size-3 rounded-full"></div>
        </HeroOrbit>
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl text-center mt-8 tracking-wide md:text-5xl">Building execptional user experiences</h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">I specialize in transforming designs into functional, high-performing web
            applications. Let's discuss about your next project.
          </p>
        </div>
