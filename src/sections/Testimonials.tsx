    ...
    <div className="py-16 lg:py-24">
      <div className="container">
        <SectionHeader eyebrow="Happy Clients" 
                     ...
                     description="Don't just take my words for it.See what my clients have to say about my work." 
        />
        <div className="mt-12 flex overflow-x-clip py-4 -my-0 [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] lg:mt-20">
